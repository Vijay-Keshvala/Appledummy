...
const Model = () => {
    ...
    const cmaeraControlSamll = useRef();
    const cmaeraControlLarge = useRef();
            ...
            <div className="flex flex-col items-center mt-5">
              <div className="w-full h-[75vh] md:h-[90vh] overflow-hidden relative">
                <ModelView 
                  ...
                  groupRef={small}
                  gsapType="view1"
                  controlRef={cmaeraControlSamll}
                  setRotationState={setSamllRotation}
                  item={model}
                  size={size}
                />  
